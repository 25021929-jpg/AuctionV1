 ...
 *
 * <p>Tập trung vào 3 method có logic thật: - isActive() : kiểm tra trạng thái phiên -
 * canAcceptBid() : kiểm tra giá đặt có hợp lệ không - applyNewBid() : cập nhật trạng thái sau khi
 * có bid mới
 *
 * <p>Không cần mock, không cần DB — tất cả là pure Java logic.
 */
