 ...
 *
 * Phạm vi test:
 *  - getAllAuctions(): validate tham số page/size
 *  - getAuctionDetail(): validate auctionId
 *  - createAuction(): validate toàn bộ các trường của CreateAuctionRequest
 *
 * Lưu ý thiết kế:
 *  AuctionService gọi DbExecutor bên trong các method.
 *  Validate format được thực hiện TRƯỚC khi gọi DbExecutor,
 *  nên các test validate KHÔNG cần mock transaction.
 */
