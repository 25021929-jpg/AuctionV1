 ...
 *
 * <p>Tại sao cần class này? Service cần quản lý transaction nhưng không được biết về Session.
 * DbExecutor đóng vai trò "gác cổng": - Mở session + transaction trước khi chạy logic - Commit khi
 * thành công - Rollback khi có exception - Đóng session trả về pool Service chỉ truyền lambda chứa
 * logic nghiệp vụ vào.
 *
 * <p>Tương đương với @Transactional của Spring Boot — nhưng bạn tự viết nên hiểu từng bánh răng.
 */
public class DbExecutor {
  ...
  /**
   * Chạy logic có transaction — không trả về giá trị. Dùng cho: save, update, delete, đặt giá...
   *
  ...
  public static void run(Runnable action) {
    ...
    try {
      ...
      // Nếu setDefaultReadOnly(true), Hibernate có thể bỏ qua dirty checking và làm thao tác ghi
      // không có hiệu lực.
