 ...
 *
 * <p>ItemImage là bảng phụ thuộc hoàn toàn vào AuctionItem. Không có ý nghĩa khi đứng độc lập.
 * Cascade ALL từ AuctionItem → save/delete item tự lo ảnh.
 *
 * <p>Repository này chủ yếu dùng khi cần thao tác ảnh riêng lẻ: thêm ảnh, xoá ảnh cụ thể, đổi ảnh
 * chính.
 */
public interface ItemImageRepository {
  ...
  /**
   * Đặt ảnh làm ảnh chính. Bước 1: set is_primary = false cho tất cả ảnh của item. Bước 2: set
   * is_primary = true cho ảnh được chọn.
   */
