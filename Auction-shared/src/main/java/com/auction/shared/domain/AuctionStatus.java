 ...
 *
 * <ul>
 *   <li>SCHEDULED: phiên đã tạo nhưng chưa tới giờ bắt đầu.
 *   <li>ACTIVE: phiên đang mở, bidder được phép đặt giá.
 *   <li>ENDED: phiên đã kết thúc tự nhiên theo thời gian.
 *   <li>CANCELLED: phiên bị hủy thủ công bởi seller/admin.
 * </ul>
 *
 * <p>Không đặt PAID trong AuctionStatus vì trạng thái thanh toán thuộc bảng payments /
 * wallet_transactions, không phải trạng thái vòng đời chính của phiên.
 */
public enum AuctionStatus {
   ...
   *
   * <p>Hệ enum cũ đã được bỏ, nhưng method này vẫn map các chuỗi legacy sang status chuẩn để tránh
   * vỡ dữ liệu/test cũ khi còn log hoặc response cũ: OPEN -> SCHEDULED, RUNNING -> ACTIVE,
   * FINISHED/PAID -> ENDED, CANCELED -> CANCELLED.
   *
