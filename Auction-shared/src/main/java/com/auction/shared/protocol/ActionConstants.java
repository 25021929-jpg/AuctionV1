 ...
 *
 * <p>This class is the single source of truth for socket action names. Client and server should
 * import constants from this class instead of hardcoding strings.
 */
