 ...
 *
 * <p>In the socket protocol, success/message/data may also be carried directly on WireMessage.
 * This class is kept as the typed response abstraction used by client services and server controllers.
 * The optional errorCode field helps client classify business errors without parsing message text.</p>
 */
