...
public class AuctionSummaryDto {
  ...
  public void setStartingPrice(double startingPrice) {
    this.startingPrice = BigDecimal.valueOf(startingPrice);
  }
  ...
  public void setMinBidStep(double minBidStep) {
    this.minBidStep = BigDecimal.valueOf(minBidStep);
  }
  ...
  public void setTotalBids(Integer totalBids) {
    this.totalBids = totalBids == null ? 0 : totalBids;
  }
