 ...
 *
 * <p>Rule này chỉ validate định dạng và điều kiện > 0 ở phía client/shared.
 * Quy tắc nghiệp vụ "giá đặt phải lớn hơn giá hiện tại" vẫn phải được kiểm tra
 * ở tầng đấu giá của server để tránh race condition.</p>
 */
