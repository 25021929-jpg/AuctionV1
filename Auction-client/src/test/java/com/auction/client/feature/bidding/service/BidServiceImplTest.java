...
class BidServiceImplTest {
  ...
  void placeBidUsesLoggedInUserIdAndBigDecimalAmount() throws IOException {
    ...
    PlaceBidRequest request =
        assertInstanceOf(PlaceBidRequest.class, communicator.lastCall().body());
  ...
  void placeBidFailsWhenUserIsNotLoggedIn() {
    ...
    ApiException exception =
        assertThrows(ApiException.class, () -> service.placeBid(12L, new BigDecimal("1500000")));
  ...
  void subscribeAuctionSendsAuctionIdRequest() throws IOException {
    ...
    AuctionIdRequest request =
        assertInstanceOf(AuctionIdRequest.class, communicator.lastCall().body());
