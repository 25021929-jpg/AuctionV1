...
class RegisterValidatorTest {
    ...
    private static final LocalDate UNDERAGE_DATE =
    ...
    void validate_emptyFullName_returnsError() {
        RegisterRequest req = new RegisterRequest(
                "", "john123", "john@gmail.com",
                "0912345678", "password123", "password123", VALID_DATE
        );
    ...
    void validate_fullNameWithNumbers_returnsError() {
        RegisterRequest req = new RegisterRequest(
                "John123", "john123", "john@gmail.com",
                "0912345678", "password123", "password123", VALID_DATE
        );
        ValidationResult result = validator.validate(req);
        assertFalse(result.valid());
    ...
    void validate_usernameTooShort_returnsError() {
        RegisterRequest req = new RegisterRequest(
                "Nguyen Van A", "ab", "john@gmail.com",
                "0912345678", "password123", "password123", VALID_DATE
        );
        ValidationResult result = validator.validate(req);
        assertFalse(result.valid());
        assertTrue(result.hasErrorFor("username"));
        assertEquals("Phải chứa ít nhất 3 ký tự",
                result.errorFor("username"));
    }
    ...
    void validate_usernameTooLong_returnsError() {
        RegisterRequest req = new RegisterRequest(
                "Nguyen Van A", "a".repeat(21), "john@gmail.com",
                "0912345678", "password123", "password123", VALID_DATE
        );
        ValidationResult result = validator.validate(req);
        assertFalse(result.valid());
    ...
    void validate_invalidPhone_returnsError() {
        RegisterRequest req = new RegisterRequest(
                ...
                "123456789", "password123", "password123", VALID_DATE
        );
        ValidationResult result = validator.validate(req);
        assertFalse(result.valid());
    ...
    void validate_passwordTooShort_returnsError() {
        RegisterRequest req = new RegisterRequest(
                "Nguyen Van A", "john123", "john@gmail.com",
                "0912345678", "abc", "abc", VALID_DATE
        );
        ValidationResult result = validator.validate(req);
        assertFalse(result.valid());
        assertTrue(result.hasErrorFor("password"));
        assertEquals("Phải chứa ít nhất 8 ký tự",
    ...
    void validate_passwordNotMatch_returnsError() {
        RegisterRequest req = new RegisterRequest(
                "Nguyen Van A", "john123", "john@gmail.com",
                "0912345678", "password123", "different", VALID_DATE
        );
        ValidationResult result = validator.validate(req);
        assertFalse(result.valid());
        assertTrue(result.hasErrorFor("confirmPassword"));
        assertEquals("Mật khẩu không khớp",
                result.errorFor("confirmPassword"));
    }
    ...
    void validate_passwordError_skipsConfirmCheck() {
        RegisterRequest req = new RegisterRequest(
                "Nguyen Van A", "john123", "john@gmail.com",
                "0912345678", "abc", "different", VALID_DATE
        );
        ValidationResult result = validator.validate(req);
        assertFalse(result.valid());
        assertTrue(result.hasErrorFor("password"));
    ...
    void validate_underage_returnsError() {
        RegisterRequest req = new RegisterRequest(
                "Nguyen Van A", "john123", "john@gmail.com",
                "0912345678", "password123", "password123", UNDERAGE_DATE
        );
        ValidationResult result = validator.validate(req);
        assertFalse(result.valid());
        assertTrue(result.hasErrorFor("birthDate"));
        assertEquals("Người dùng phải từ 18 tuổi trở lên",
                result.errorFor("birthDate"));
    }
    ...
    void validate_nullBirthDate_returnsError() {
        RegisterRequest req = new RegisterRequest(
                "Nguyen Van A", "john123", "john@gmail.com",
                "0912345678", "password123", "password123", null
        );
        ValidationResult result = validator.validate(req);
        assertFalse(result.valid());
        assertTrue(result.hasErrorFor("birthDate"));
