...
public class WalletServiceImpl implements WalletService {
  ...
  public WalletSummaryDto getSummary() throws IOException {
    ...
    Response<WalletSummaryDto> response =
        communicator.send(ActionConstants.WALLET_GET_SUMMARY, request, WalletSummaryDto.class);
  ...
  public WalletSummaryDto deposit(BigDecimal amount) throws IOException {
    ...
    Response<WalletSummaryDto> response =
        communicator.send(ActionConstants.WALLET_DEPOSIT, request, WalletSummaryDto.class);
  ...
  public List<WalletTransactionDto> getTransactions(int limit) throws IOException {
    ...
    Response<WalletTransactionDto[]> response =
        communicator.send(
            ActionConstants.WALLET_GET_TRANSACTIONS, request, WalletTransactionDto[].class);
    WalletTransactionDto[] rows =
        ResponseUtils.unwrap(ActionConstants.WALLET_GET_TRANSACTIONS, response);
