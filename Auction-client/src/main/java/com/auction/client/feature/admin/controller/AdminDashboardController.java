 ...
 *
 * Lưu ý:
 * - Không đoán nghiệp vụ admin phía server. Màn hình này chủ yếu giúp debug realtime/event.
 * - Khi team server chốt thêm API admin, ta sẽ bổ sung AdminService theo ActionConstants mà không phải refactor UI nhiều.
 */
public class AdminDashboardController implements DisposableController {
    ...
    public void initialize() {
        ...
        lblSessionInfo.setText(session.isLoggedIn()
