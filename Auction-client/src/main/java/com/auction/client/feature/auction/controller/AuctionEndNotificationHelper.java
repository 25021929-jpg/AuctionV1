 ...
 *
 * <p>Helper này được dùng lại ở nhiều màn hình để tránh trùng logic và tránh
 * hiện nhiều popup cho cùng một người dùng/cùng một phiên.</p>
 */
public final class AuctionEndNotificationHelper {
     ...
     * @param showGenericForCurrentAuction true nếu muốn báo chung cho người đang xem phiên nhưng chưa đặt giá
     */
    public static void showIfEnded(AppEvent event, Long currentAuctionId, boolean showGenericForCurrentAuction) {
        ...
        if (currentUserId.equals(sellerId)) {
            ...
            if (winnerId != null && winnerId > 0) {
                message = "Đã bán thành công " + itemName
                        + " (phiên #" + auctionId + "). Người thắng: " + winnerUsername + ".";
            } else {
                message = "Phiên #" + auctionId + " của " + itemName
