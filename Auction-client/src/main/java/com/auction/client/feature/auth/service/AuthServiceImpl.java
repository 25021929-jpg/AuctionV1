...
public class AuthServiceImpl implements AuthService {
  ...
  public AuthResponse login(LoginRequest request) throws IOException {
    Response<AuthResponse> response =
        communicator.send(ActionConstants.AUTH_LOGIN, request, AuthResponse.class);
  ...
  public void register(RegisterRequest request) throws IOException {
    Response<Void> response = communicator.send(ActionConstants.AUTH_REGISTER, request, Void.class);
