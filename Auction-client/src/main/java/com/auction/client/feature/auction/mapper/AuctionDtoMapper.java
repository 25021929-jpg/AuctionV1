 ...
 *
 * <p>Thiết kế tách riêng để: - Dễ unit-test mapping mà không cần chạy server. - Khi server chốt
 * schema, chỉ sửa mapper.
 */
public final class AuctionDtoMapper {
  ...
  public static AuctionSummaryDto toSummary(JsonObject o) {
    ...
    dto.setCurrentPrice(
        orZero(JsonRead.optBigDecimal(o, "currentPrice", "currentBid", "highestBid", "price")));
  ...
  public static AuctionDetailDto toDetail(JsonObject o, long fallbackAuctionId) {
    ...
    dto.setStartPrice(
        orZero(JsonRead.optBigDecimal(o, "startPrice", "startingPrice", "reservePrice")));
    dto.setCurrentPrice(
        orZero(JsonRead.optBigDecimal(o, "currentPrice", "currentBid", "highestBid", "price")));
    dto.setMinBidStep(JsonRead.optBigDecimal(o, "minBidStep", "bidStep", "minimumBidStep"));
    Long total = JsonRead.optLong(o, "totalBids", "bidCount", "numberOfBids");
