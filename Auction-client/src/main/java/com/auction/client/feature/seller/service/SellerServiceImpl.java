 ...
 *
 * <p>Nguyên tắc: - Parse tolerant, không phụ thuộc schema cứng. - Khi server chốt schema, chỉ cần
 * sửa mapping tại đây.
 */
public class SellerServiceImpl implements SellerService {
  ...
  public void createItem(SellerItemDto item) throws IOException {
    ...
    Response<Void> res =
        SocketClient.getInstance().send(ActionConstants.SELLER_ITEM_CREATE, request, Void.class);
  ...
  public void updateItem(SellerItemDto item) throws IOException {
    ...
    Response<Void> res =
        SocketClient.getInstance().send(ActionConstants.SELLER_ITEM_UPDATE, request, Void.class);
  ...
  public void deleteItem(SellerItemDto item) throws IOException {
    ...
    DeleteSellerItemRequest request =
        new DeleteSellerItemRequest(item.getItemId(), auctionId, sellerId);

    Response<Void> res =
        SocketClient.getInstance().send(ActionConstants.SELLER_ITEM_DELETE, request, Void.class);
  ...
  private void copyEditableFields(
      SellerItemDto item, CreateSellerItemRequest request, String action) throws ApiException {
