...
/**
 * Chuyển exception kỹ thuật/nghiệp vụ thành thông báo thân thiện cho UI.
 * Controller chỉ nên gọi class này thay vì tự phân nhánh nhiều loại lỗi.
 */
public final class ErrorHandler {
    ...
    public static String getUserMessage(Throwable error) {
        ...
        if (t instanceof ConnectionException) {
            return fallback(t.getMessage(), "Không thể kết nối tới server. Vui lòng kiểm tra server đã chạy chưa.");
        }
        ...
        return fallback(t == null ? null : t.getMessage(), "Đã xảy ra lỗi không xác định. Vui lòng thử lại.");
    }
