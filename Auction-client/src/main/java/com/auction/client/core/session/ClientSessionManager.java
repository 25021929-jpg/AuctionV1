 ...
 *
 * <p>Lưu ý: logout chỉ xóa session và quay về màn đăng nhập. Không tự đóng socket vì socket vẫn có
 * thể dùng lại cho lần đăng nhập tiếp theo, đồng thời tránh phát sinh CONNECTION_LOST giả khi người
 * dùng chủ động đăng xuất.
 */
