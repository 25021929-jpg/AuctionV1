 ...
 *
 * <p>The canonical action contract now lives in
 * {@link com.auction.shared.protocol.ActionConstants}. New code should import the shared class.</p>
 */
...
public final class ActionConstants {
    ...
    public static final String AUTH_REGISTER = com.auction.shared.protocol.ActionConstants.AUTH_REGISTER;

    public static final String AUCTION_GET_LIST = com.auction.shared.protocol.ActionConstants.AUCTION_GET_LIST;
    public static final String AUCTION_GET_DETAIL = com.auction.shared.protocol.ActionConstants.AUCTION_GET_DETAIL;
    public static final String AUCTION_SUBSCRIBE = com.auction.shared.protocol.ActionConstants.AUCTION_SUBSCRIBE;
    ...
    public static final String SELLER_ITEM_UPDATE = com.auction.shared.protocol.ActionConstants.SELLER_ITEM_UPDATE;
    public static final String SELLER_ITEM_DELETE = com.auction.shared.protocol.ActionConstants.SELLER_ITEM_DELETE;

    public static final String EVENT_BID_UPDATED = com.auction.shared.protocol.ActionConstants.EVENT_BID_UPDATED;
    public static final String EVENT_AUCTION_STATUS_CHANGED = com.auction.shared.protocol.ActionConstants.EVENT_AUCTION_STATUS_CHANGED;
}
